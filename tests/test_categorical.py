"""Tests for categorical bias-aware hierarchical clustering algorithms."""
...
CATEGORICAL_ALGORITHMS = [BiasAwareHierarchicalKModes]
CATEGORICAL_ALGORITHMS_WITH_PREDICT = [BiasAwareHierarchicalKModes]


@pytest.fixture
def data():
    """Generate random data with categorical features for testing."""
    rng = np.random.RandomState(12)
    X = rng.randint(0, 5, size=(20, 10))
    y = rng.rand(20)
    return X, y


@pytest.mark.parametrize("algorithm", CATEGORICAL_ALGORITHMS, ids=lambda a: a.__name__)
