...
def load_default_dataset():
    ...
    Note: it is up to the user to train a model with the provided data now before running the bias detection tool whether it is via the Algorithm Audit website for a demo or via the unsupervised_bias_detection package.
    >>> x
                       race  gender                    age  ... had_outpatient_days readmitted  readmit_binary
